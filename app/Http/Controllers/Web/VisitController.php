...
class VisitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->id != null) {
                $message = 'Berhasil memperbarui Kunjungan';
            ...
            $absensi->t_absensi_startClock = $request['absensi']['startClock'] != null ? "$date " . ' ' . $request['absensi']['startClock'] : null;
            $absensi->t_absensi_endClock = $request['absensi']['endClock'] != null ? "$date " . ' ' . $request['absensi']['endClock'] : null;
            $absensi->t_absensi_status = 4;
    ...
    {
        $message = 'Berhasil menghapus Data Absensi Visit';
    ...
    public function ExportExcel(Request $request)
    {
        ...
        $url = "Laporan Kunjungan $name ($start ~ $end).xlsx";
        $excel = Excel::store(new VisitExport($data), $url, 'excel', null, [
            'visibility' => 'public',
        ]);
